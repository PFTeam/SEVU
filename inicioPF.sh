...
rails generate scaffold Presupuesto fechaPresentacion:date montoTotal:integer aprobado:boolean proyecto:references restriccion:references usuario:references
