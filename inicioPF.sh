...
rails generate scaffold DetalleRestriccion esActiva:boolean fechaDesde:date fechaHasta:date montoMax:floatDetalleRestriccion restriccion:references concepto_gasto:references
