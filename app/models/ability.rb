			...
			AsignacionFuncion.all.each do |asignacionfuncion| #Privilegios de Sistema
				if asignacionfuncion.usuario == user && asignacionfuncion.esActual?	
					...
					if asignacionrolpredefinido.esActual?
						...
						if asignacionrolpredefinido.rol==asignacionfuncion.rol && asignacionrolpredefinido.privilegio.id==(Privilegio.find_by! nombre: 'new_postulacion').id 
						...
						if asignacionrolpredefinido.rol==asignacionfuncion.rol && asignacionrolpredefinido.privilegio.id==(Privilegio.find_by! nombre: 'notificacion_email').id 
						...
						if asignacionrolpredefinido.rol==asignacionfuncion.rol && asignacionrolpredefinido.privilegio.id==(Privilegio.find_by! nombre: 'notificacion_mailer').id 
