class EstadoActividadsController < ApplicationController
  ...
  # PATCH/PUT /estado_actividads/1
  # PATCH/PUT /estado_actividads/1.json
  def update
    respond_to do |format|
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to estado_actividads_url, notice: 'Estado actividad was successfully destroyed.' }
