  ...
  def create
    ...
    respond_to do |format|
      if @estado_actividad.save
        format.html { redirect_to @estado_actividad
flash[:success] = 'Estado actividad fue creado satisfactoriamente.' }
  ...
  def update
    ...
    respond_to do |format|
      if @estado_actividad.update(estado_actividad_params)
        format.html { redirect_to @estado_actividad
flash[:success] = 'Estado actividad fue actualizado satisfactoriamente.' }
