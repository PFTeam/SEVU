class TipoNotificacionsController < ApplicationController
  before_action :set_tipo_notificacion, only: [:show, :edit, :update, :destroy]

  # GET /tipo_notificacions
  # GET /tipo_notificacions.json
  def index
    @tipo_notificacions = TipoNotificacion.all
  end

  # GET /tipo_notificacions/1
  # GET /tipo_notificacions/1.json
  def show
  end

  # GET /tipo_notificacions/new
  def new
    @tipo_notificacion = TipoNotificacion.new
  end

  # GET /tipo_notificacions/1/edit
  def edit
  end

  # POST /tipo_notificacions
  # POST /tipo_notificacions.json
  def create
  ...
  # PATCH/PUT /tipo_notificacions/1
  # PATCH/PUT /tipo_notificacions/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /tipo_notificacions/1
  # DELETE /tipo_notificacions/1.json
  def destroy
    @tipo_notificacion.destroy
    respond_to do |format|
      format.html { redirect_to tipo_notificacions_url, notice: 'Tipo notificacion was successfully destroyed.' }
