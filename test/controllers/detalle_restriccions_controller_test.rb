...
class DetalleRestriccionsControllerTest < ActionController::TestCase
  setup do
    @detalle_restriccion = detalle_restriccions(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:detalle_restriccions)
  end
  ...
  test "should destroy detalle_restriccion" do
    ...
    assert_redirected_to detalle_restriccions_path
  end
end
