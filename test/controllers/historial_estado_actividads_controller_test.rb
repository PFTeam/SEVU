...
class HistorialEstadoActividadsControllerTest < ActionController::TestCase
  setup do
    @historial_estado_actividad = historial_estado_actividads(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:historial_estado_actividads)
  end
  ...
  test "should destroy historial_estado_actividad" do
    ...
    assert_redirected_to historial_estado_actividads_path
  end
end
