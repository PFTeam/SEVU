...
class NotificacionEmailsControllerTest < ActionController::TestCase
  setup do
    @notificacion_email = notificacion_emails(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:notificacion_emails)
  end
  ...
  test "should destroy notificacion_email" do
    ...
    assert_redirected_to notificacion_emails_path
  end
end
