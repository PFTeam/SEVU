...
class AsignacionActividadsControllerTest < ActionController::TestCase
  setup do
    @asignacion_actividad = asignacion_actividads(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:asignacion_actividads)
  end
  ...
  test "should destroy asignacion_actividad" do
    ...
    assert_redirected_to asignacion_actividads_path
  end
end
