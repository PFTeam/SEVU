...
class AsignacionFuncionesControllerTest < ActionController::TestCase
  ...
  test "should create asignacion_funcion" do
    assert_difference('AsignacionFuncion.count') do
      post :create, asignacion_funcion: { descripcion: @asignacion_funcion.descripcion, esActual: @asignacion_funcion.esActual, fechaAsignacion: @asignacion_funcion.fechaAsignacion, rol_id: @asignacion_funcion.rol_id, usuario_id: @asignacion_funcion.usuario_id }
    end
  ...
  test "should update asignacion_funcion" do
    patch :update, id: @asignacion_funcion, asignacion_funcion: { descripcion: @asignacion_funcion.descripcion, esActual: @asignacion_funcion.esActual, fechaAsignacion: @asignacion_funcion.fechaAsignacion, rol_id: @asignacion_funcion.rol_id, usuario_id: @asignacion_funcion.usuario_id }
    assert_redirected_to asignacion_funcion_path(assigns(:asignacion_funcion))
  end
