...
class ProyectoTipoNotificacionesControllerTest < ActionController::TestCase
  setup do
    @proyecto_tipo_notificacion = proyecto_tipo_notificaciones(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:proyecto_tipo_notificaciones)
  end
  ...
  test "should destroy proyecto_tipo_notificacion" do
    ...
    assert_redirected_to proyecto_tipo_notificaciones_path
  end
end
