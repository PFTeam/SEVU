...
class NotaPersonalesControllerTest < ActionController::TestCase
  setup do
    @nota_personal = nota_personales(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:nota_personales)
  end
  ...
  test "should destroy nota_personal" do
    ...
    assert_redirected_to nota_personales_path
  end
end
